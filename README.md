...
|------|-----|--------------|
| `index.html` | https://ssfahim.github.io/md-chunker/ | Paste text → collapsed N-line chunks with per-chunk Copy buttons. Default 150 lines. Optional "don't split inside ``` code blocks". Dark theme. |
